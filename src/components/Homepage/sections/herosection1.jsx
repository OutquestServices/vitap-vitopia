    ...
    return (
        <div className="w-full h-[50vh] sm:h-[60vh] md:h-[80vh] lg:h-screen relative bg-cover bg-center" style={{ backgroundImage: `url('/bk.png')` }}>
            <div className="absolute top-10 left-8 md:top-20 md:left-24 lg:top-10 lg:left-40 flex flex-col gap-6 md:gap-0 items-start justify-center w-fit h-fit">
                ...
                <div className="flex md:flex-row flex-col gap-4 md:space-x-4 md:mt-8 items-start justify-start text-center w-full h-full">
                    <a href="/merchandise" target="_blank" className="testFont bg-[#FF8321] text-black font-semibold text-sm md:font-bold md:text-lg px-6 py-1 md:px-14 md:py-3 shadow-lg w-full md:w-[93%]">
                        ProShow Events
                    </a>
                </div>
                <div className="flex md:flex-row flex-col gap-4 md:space-x-4 md:mt-8 items-start justify-start w-full h-full">
                    <a href="/culturals" target="_blank" className="testFont border-2 text-white font-semibold text-sm md:font-semibold md:text-lg px-5 py-1 md:px-10 md:py-3 shadow-lg">
                        Prime Events
                    </a>
